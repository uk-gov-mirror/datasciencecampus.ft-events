# Code of conduct for `repo_cookiecutter`

Contributors to this repository hosted by `ONS-fintrans` are expected to follow the
...
- "Project", we mean this `repo_cookiecutter` GitHub repository;
- "Maintainer", we mean the `ONS-fintrans` organisation owners; and
- "Leadership", we mean both `ONS-fintrans` organisation owners, line managers, and other
...
[alex.holmes@ons.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:alex.holmes@ons.gov.uk
